...
export const TRANSLATIONS = {
  en: {
    ...
    exportCurrentTitle: 'Current Canvas View',
    exportCurrentDesc: 'Active diagram with reactions & internal forces',
    exportExerciseTitle: 'Unsolved Problem (Student Exercise)',
    exportExerciseDesc: 'Clean structure & loads only (for homework/exams)',
    toastExportCanvasSuccess: '📸 Canvas diagram exported as PNG',
    toastExportExerciseSuccess: '🎓 Student exercise problem exported as PNG',
  ...
  pl: {
    ...
    exportCurrentTitle: 'Aktualny widok (Wykresy i wyniki)',
    exportCurrentDesc: 'Wykresy sił wewnętrznych i reakcje podpór',
    exportExerciseTitle: 'Schemat zadania (Ćwiczenie dla studentów)',
    exportExerciseDesc: 'Czysty schemat z wymiarami i obciążeniem (na kolokwium/egzamin)',
    toastExportCanvasSuccess: '📸 Wykres belki wyeksportowany jako PNG',
    toastExportExerciseSuccess: '🎓 Schemat zadania wyeksportowany jako PNG',
